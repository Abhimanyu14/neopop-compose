...
@Composable
fun NeoPopElevatedStrokeButtonSample() {
    Box(
...
fun NeoPopElevatedStrokeButton(
    ...
    NeoPopElevatedStrokeButtonView(
        text = text,
        modifier = modifier,
        elevation = elevation,
        maxElevation = 4.dp,
...
@Composable
private fun NeoPopElevatedStrokeButtonView(
    text: String,
    ...
    Canvas(
        ...
        drawRect(
            color = Color.Black,
            topLeft = Offset(
                x = (maxElevation - elevation + strokeWidth).toPx(),
                y = (maxElevation - elevation + strokeWidth).toPx(),
            ),
            size = Size(
                width = (width - (strokeWidth * 2)).toPx(),
                height = (height - (strokeWidth * 2)).toPx(),
            ),
        )
        drawRect(
            color = Color.White,
            topLeft = Offset(
                x = (maxElevation - elevation).toPx() + (strokeWidth / 2).toPx(),
                y = (maxElevation - elevation).toPx() + (strokeWidth / 2).toPx(),
            ),
            size = Size(
                width = (width - (strokeWidth)).toPx(),
                height = (height - (strokeWidth)).toPx(),
            ),
            style = Stroke(
